        ...
        <div className="rounded-[1rem] border border-white/10 bg-black/30 p-4">
          ...
          <div className="mt-4 space-y-3">
            {checklist.checklistItems.map((item) => (
              <div key={item.id} className="rounded-[0.95rem] border border-white/10 bg-black/40 px-4 py-3">
                <div className="flex gap-3">
                  <span className="mt-0.5 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded border border-white/20 bg-black/50 text-[10px] text-slate-400">
                    [ ]
                  </span>
                  <div>
        ...
        <div className="rounded-[1rem] border border-white/10 bg-black/30 p-4">
          ...
          <ol className="mt-4 space-y-3">
            {checklist.documentStackOrder.map((item, index) => (
              <li key={item} className="flex gap-3 rounded-[0.95rem] border border-white/10 bg-black/40 px-4 py-3">
