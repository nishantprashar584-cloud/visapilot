  ...
  if (mappedPdf && (await templateExists(mappedPdf.templatePath))) {
    ...
    return {
      ...
      guidanceMessage: hasNativeFields
        ? null
        : `The available ${destinationCountry} official template is a flat PDF without interactive AcroForm fields, so VisaPilot generated a clean worksheet PDF and prioritizes the print-ready visa packet for printing.`,
    };
  }
